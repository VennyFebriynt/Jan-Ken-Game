...
function janken(tangan) {
    ...
    switch (jariKen) {
        case 0:
            ken.style.backgroundImage = "url(Jaken-game/ken-batu.png)";
            break;
        case 1:
            ken.style.backgroundImage = "url(Jaken-game/ken-gunting.png)";
            break;
        default:
            ken.style.backgroundImage = "url(Jaken-game/ken-kertas.png)";
            break;
    }
